...
//  }
//
//  //Initiate glew and allow us to use all OpenGL features no matter how "new". Some drivers think old things are new, so always do this
//  glewExperimental = GL_TRUE;
//  glewInit();
//
//  //Initiate OpenGL visually
//  glClearColor(1.0, 0.0, 0.0, 1.0);
//
//  //Do Work
//  glClear(GL_COLOR_BUFFER_BIT);
//
//  //Move BackBuffer to Front, updating our changes
//  SDL_GL_SwapWindow(window);
//
//  //Wait 2 seconds cause we don't have a game loop
//  SDL_Delay(2000);
//
//  //Destroy window
